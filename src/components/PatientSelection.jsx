      ...
      return (
        <div className="absolute inset-0 w-full h-full bg-white flex flex-col items-center justify-center animate-in scale-in duration-300">
          ...
          <div className="absolute top-[100px] w-full flex justify-center">
            <div className="w-14 h-14 bg-cyan-50 border border-cyan-100 text-cyan-600 rounded-full flex items-center justify-center shadow-sm"><i className="fa-solid fa-lungs text-2xl"></i></div>
          </div>
          <div className="absolute top-[180px] w-full flex justify-center">
            <button onClick={() => handleBreathsDone(false)} className="w-[85%] max-w-[260px] h-[60px] bg-cyan-50/80 text-cyan-700 rounded-full font-black uppercase tracking-[0.15em] text-[15px] shadow-[0_8px_25px_rgba(6,182,212,0.04)] border border-cyan-200 active:scale-95 transition-all flex items-center justify-center gap-3">
              <i className="fa-solid fa-lungs text-2xl text-cyan-400"></i>
              <span>Durchgeführt</span>
            </button>
          </div>
          <div className="absolute top-[260px] w-full flex justify-center">
            <button onClick={() => handleBreathsDone(true)} className="w-[85%] max-w-[260px] h-[45px] bg-white text-slate-400 rounded-full font-bold uppercase tracking-[0.25em] text-[12px] shadow-sm border border-slate-100 active:scale-95 transition-all flex items-center justify-center gap-2">
    ...
    case 'OB_COMPRESSIONS':
      return (
        <div className="absolute inset-0 w-full h-full bg-white flex flex-col items-center justify-center animate-in fade-in duration-300">
          ...
          <div className="absolute top-[110px] w-full flex justify-center">
    ...
    case 'OB_ANALYZE':
      return (
        <div className="absolute inset-0 w-full h-full bg-white flex flex-col items-center justify-center overflow-hidden animate-in fade-in duration-300">
          ...
          <div className="absolute top-[45px] w-full flex justify-center z-10">
          ...
          <div className="absolute top-[195px] w-full flex justify-center z-10">
            <button onClick={handleAnalyseClick} className="w-[85%] max-w-[260px] h-[60px] bg-white text-[#E3000F] rounded-full font-black uppercase tracking-[0.15em] text-[15px] shadow-[0_8px_25px_rgba(227,0,15,0.06)] border border-red-100 transition-all flex items-center justify-center gap-3 animate-pulse active:scale-95">
